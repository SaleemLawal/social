        ...
        "/users/feeds": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Return posts created after this time (RFC3339)",
                        "name": "since",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "Return posts created before this time (RFC3339)",
                        "name": "until",
                        "in": "query"
                    }
                ],
    ...
    "definitions": {
        ...
        "main.registerUserRequest": {
            ...
            "properties": {
                ...
                "password": {
                    "description": "TODO: add password complexity rules",
                    "type": "string",
                    "maxLength": 72,
                    "minLength": 3
                },
